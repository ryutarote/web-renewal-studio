...
(function () {
  ...
  const DESC = {
    home:  "長浜ラーメンの元祖「元祖長浜屋」（リニューアル提案）。昭和27年創業。あっさりとしたとんこつスープに極細麺。麺の硬さ・油・ネギを伝えて注文する、替玉発祥の店としても知られる福岡の名物。",
    menu:  "元祖長浜屋のお品書き。ラーメン、替玉など。価格は税込・目安です。福岡・長浜。",
    story: "元祖長浜屋の歩み。昭和27年、屋台から創業。長浜ラーメンと替玉の元祖として知られる老舗。",
    shop:  "元祖長浜屋の店舗情報・アクセス。福岡市中央区長浜2-5-25／092-711-8154。早朝から深夜まで。",
    order: "元祖長浜屋のお取り寄せ（提案デモ）。長浜ラーメンの通販など、家庭で味わう構成例。"
  };
  const views = $$(".view");
  ...
  function renderCart() {
    ...
    if (ids.length === 0) {
      cartItemsEl.innerHTML = `<div class="cart-empty"><p>カートは空です。<br>通販の長浜ラーメンはいかがですか？</p><a class="btn btn-primary" href="#/order">お取り寄せを見る</a></div>`;
    } else {
