...
(function () {
  ...
  const DESC = {
    home:  "名古屋・上前津のからあげ専門店「天下鳥ます」（リニューアル提案）。揚げたてジューシーなからあげと、ボリューム満点のからあげ弁当。上前津駅すぐ。テイクアウト・通販も。",
    menu:  "天下鳥ますのお品書き。看板のからあげ（S/M/L）、特製からあげ弁当、白身魚・アジフライとの弁当、皮のからあげやサイドまで。名古屋・上前津のからあげ専門店。",
    story: "天下鳥ますのこだわり。注文を受けてから揚げる、衣はサクッと中はジューシーなからあげ。タルタルソースのトッピングや弁当スタイルの楽しみ方をご紹介します。",
    shop:  "天下鳥ますの店舗情報・アクセス。愛知県名古屋市中区上前津2-3-26／鶴舞線「上前津駅」3番出口すぐ。営業11:00〜20:00、定休 不定休。",
    order: "天下鳥ますのテイクアウト・通販。からあげ弁当のお持ち帰りや、ご家庭で楽しむ冷凍からあげを。アカウント登録不要のゲスト購入OK（デモ）。"
  };
  const views = $$(".view");
