...
const PRODUCTS = [
  {
    id: "tororo",
    name: "とろろ（冷凍・2食）",
    desc: "自然薯のとろろを白味噌だしで。麦めしにかけてご家庭で。",
    price: 1600,
    grad: "radial-gradient(circle at 42% 32%, #b8c46a, #2e3a22 72%)",
    note: "構成例（目安）"
  },
  {
    id: "shiromiso-dashi",
    name: "白味噌だし",
    desc: "とろろをのばす自家製白味噌だし。味噌汁にも。",
    price: 800,
    grad: "radial-gradient(circle at 45% 35%, #6a7a3a, #222a18 72%)"
  },
  {
    id: "tororo-gift",
    name: "とろろ汁 詰合せ（ギフト）",
    desc: "とろろとだし、麦めしの素の詰合せ。ご進物に。",
    price: 3000,
    grad: "linear-gradient(135deg, #2e3a22, #b8c46a)"
  }
];
...
const CART_KEY = "shizuoka_chojiya_cart_v1";
