...
const PRODUCTS = [
  {
    id: "chickenrice",
    name: "チキンライスの素",
    desc: "玉ねぎの甘みを生かしたチキンライスの素。卵で包めば元祖の一皿に。",
    price: 900,
    grad: "radial-gradient(circle at 42% 32%, #f0bf3d, #7a2218 72%)",
    note: "構成例（目安）"
  },
  {
    id: "ketchup",
    name: "オムライス用ケチャップ",
    desc: "オムライスに合わせて仕立てたケチャップ。",
    price: 800,
    grad: "radial-gradient(circle at 45% 35%, #e07a3a, #6a1f14 72%)"
  },
  {
    id: "frozen-omu",
    name: "冷凍チキンオムライス 2食",
    desc: "温めるだけで元祖の味。お弁当やお夜食に。",
    price: 2000,
    grad: "linear-gradient(135deg, #7a2218, #f0bf3d)"
  }
];
...
const CART_KEY = "osaka_hokkyokusei_cart_v1";
