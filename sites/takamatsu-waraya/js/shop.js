...
const PRODUCTS = [
  {
    id: "sanuki-udon",
    name: "讃岐うどん（半生・3人前）",
    desc: "コシのある讃岐うどんとだしのセット。釜揚げで熱々を。",
    price: 1500,
    grad: "radial-gradient(circle at 42% 32%, #e0b24a, #3a2a18 72%)",
    note: "構成例（目安）"
  },
  {
    id: "udon-dashi",
    name: "釜揚げ用だし",
    desc: "徳利でおなじみの熱い出汁。うどんや鍋に。",
    price: 700,
    grad: "radial-gradient(circle at 45% 35%, #c4922f, #2a1e10 72%)"
  },
  {
    id: "udon-gift-w",
    name: "讃岐うどん 詰合せ（ギフト）",
    desc: "うどんとだしの詰合せ。ご進物に。",
    price: 2600,
    grad: "linear-gradient(135deg, #3a2a18, #e0b24a)"
  }
];
...
const CART_KEY = "takamatsu_waraya_cart_v1";
