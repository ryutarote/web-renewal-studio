...
(function () {
  ...
  const DESC = {
    home:  "屋島のふもとの讃岐うどん「ざいごうどん本家 わら家」（リニューアル提案）。茅葺きの古民家で、熱々の釜揚げうどんを徳利の出汁で。コシのある麺と香り高いだしを、風情ある空間で。",
    menu:  "わら家のお品書き。釜揚げうどん（並・中ジャンボ・特大・家族）、ざる、ぶっかけなど。価格は税込・目安です。高松・屋島。",
    story: "わら家の歩み。屋島のふもとで、茅葺きの古民家とともに讃岐うどんを供する人気店。名物は釜揚げうどん。",
    shop:  "ざいごうどん本家 わら家の店舗情報・アクセス。香川県高松市屋島中町91／087-843-3115。屋島。年中無休。",
    order: "わら家のお取り寄せ（提案デモ）。讃岐うどんの通販など、家庭で味わう構成例。"
  };
  const views = $$(".view");
  ...
  function renderCart() {
    ...
    if (ids.length === 0) {
      cartItemsEl.innerHTML = `<div class="cart-empty"><p>カートは空です。<br>讃岐うどんの通販はいかがですか？</p><a class="btn btn-primary" href="#/order">お取り寄せを見る</a></div>`;
    } else {
