...
(function () {
  ...
  const DESC = {
    home:  "名古屋名物ひつまぶし発祥の店「あつた蓬莱軒」（リニューアル提案）。明治6年創業の老舗うなぎ店。本店は熱田神宮ほど近く。冷凍ひつまぶし・うなぎ蒲焼のお取り寄せも。",
    menu:  "あつた蓬莱軒のお品書き。発祥の地のひつまぶし、うな丼、白焼など。四つの食べ方で味わう、明治6年創業の名古屋名物うなぎ料理。価格は税込・目安。",
    story: "あつた蓬莱軒の物語。明治6年（1873）創業。当店発祥とされる「ひつまぶし」は登録商標。受け継がれるうなぎの味と、四つの食べ方の歴史。",
    shop:  "あつた蓬莱軒の店舗情報・アクセス。本店は名古屋市熱田区神戸町503／052-671-8686。熱田神宮ほど近く。神宮店・松坂屋店ほか名古屋市内に複数店舗。",
    order: "あつた蓬莱軒のお取り寄せ。冷凍ひつまぶし、うなぎ蒲焼、出汁・薬味付きセット、進物用化粧箱。ご家庭で名古屋名物を。アカウント登録不要のゲスト購入OK（デモ）。"
  };
  const views = $$(".view");
  ...
  function renderCart() {
    ...
    if (ids.length === 0) {
      cartItemsEl.innerHTML = `<div class="cart-empty"><p>カートは空です。<br>冷凍ひつまぶし・うなぎ蒲焼のお取り寄せはいかがですか？</p><a class="btn btn-primary" href="#/order">お取り寄せを見る</a></div>`;
    } else {
