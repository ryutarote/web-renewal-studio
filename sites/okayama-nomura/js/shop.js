...
const PRODUCTS = [
  {
    id: "domi-sauce",
    name: "ドミグラスソース",
    desc: "甘くまろやかな秘伝のソース。カツやオムライスに。",
    price: 800,
    grad: "radial-gradient(circle at 42% 32%, #e0902f, #3a2014 72%)",
    note: "構成例（目安）"
  },
  {
    id: "katsudon-kit",
    name: "デミカツ丼の素（ソース＋カツ）",
    desc: "ソースと冷凍カツのセット。ご飯にのせて元祖の味を。",
    price: 1800,
    grad: "radial-gradient(circle at 45% 35%, #c4702f, #2a1610 72%)"
  },
  {
    id: "domi-set",
    name: "ドミグラスソース 詰合せ",
    desc: "ソースの詰合せ。ご家庭の洋食に。",
    price: 2200,
    grad: "linear-gradient(135deg, #3a2014, #e0902f)"
  }
];
...
const CART_KEY = "okayama_nomura_cart_v1";
