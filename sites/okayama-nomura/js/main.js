...
(function () {
  ...
  const DESC = {
    home:  "岡山名物ドミカツ丼の元祖「味司 野村」（リニューアル提案）。昭和6年創業。代々受け継ぐ秘伝のドミグラスソースを、サクッと揚げたカツと茹でキャベツ、ごはんにたっぷりと。甘くまろやかな一杯。",
    menu:  "味司 野村のお品書き。ドミグラスソースかつ丼、カツ丼など。価格は税込・目安です。岡山。",
    story: "野村の歩み。昭和6年創業。岡山のご当地グルメ「デミカツ丼」の元祖として、秘伝ソースを受け継ぐ老舗。",
    shop:  "味司 野村の店舗情報・アクセス。岡山県岡山市北区平和町1-10／086-222-2234。岡山駅前。",
    order: "野村のお取り寄せ（提案デモ）。ドミグラスソースなど、家庭で味わう構成例。"
  };
  const views = $$(".view");
  ...
  function renderCart() {
    ...
    if (ids.length === 0) {
      cartItemsEl.innerHTML = `<div class="cart-empty"><p>カートは空です。<br>ドミグラスソースはいかがですか？</p><a class="btn btn-primary" href="#/order">お取り寄せを見る</a></div>`;
    } else {
