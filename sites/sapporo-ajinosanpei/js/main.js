...
(function () {
  ...
  const DESC = {
    home:  "札幌・味噌ラーメン発祥の店「味の三平」（リニューアル提案）。初代・大宮守人が考案した元祖味噌ラーメン。札幌市中央区南1条西3丁目・大丸藤井セントラルビル4F。発祥の味を札幌の中心で。",
    menu:  "味の三平のお品書き。元祖の味噌ラーメン、正油・しお、からい鉄火麺、ワンタンメンなど。中太ちぢれ麺と炒め野菜の発祥の一杯。価格は税込・目安。",
    story: "味の三平の物語。戦後に札幌・すすきので創業し、初代・大宮守人が味噌ラーメンを考案。札幌味噌ラーメンの原点となった発祥の店の歴史と、おいしさの秘密。",
    shop:  "味の三平の店舗情報・アクセス。札幌市中央区南1条西3丁目 大丸藤井セントラルビル4F／011-231-0377。地下鉄「大通」駅から徒歩約2分。",
    order: "味の三平のお取り寄せ。監修の札幌味噌ラーメンセット。ご家庭で発祥の味を。アカウント登録不要のゲスト購入OK（デモ）。"
  };
  const views = $$(".view");
  ...
  function renderCart() {
    ...
    if (ids.length === 0) {
      cartItemsEl.innerHTML = `<div class="cart-empty"><p>カートは空です。<br>監修の味噌ラーメンセットのお取り寄せはいかがですか？</p><a class="btn btn-primary" href="#/order">お取り寄せを見る</a></div>`;
    } else {
