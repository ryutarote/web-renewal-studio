...
const PRODUCTS = [
  {
    id: "soba-set",
    name: "そば（半生・3人前）",
    desc: "香り高いそば。つゆを添えてご家庭で打ち分けの味を。",
    price: 1500,
    grad: "radial-gradient(circle at 42% 32%, #b6a05a, #2a3340 72%)",
    note: "構成例（目安）"
  },
  {
    id: "sobatsuyu",
    name: "そばつゆ",
    desc: "返しの効いたそばつゆ。もり・ざるに。",
    price: 800,
    grad: "radial-gradient(circle at 45% 35%, #4a5a68, #1c2530 72%)"
  },
  {
    id: "soba-gift",
    name: "そば詰合せ（ギフト）",
    desc: "そばとつゆの詰合せ。ご進物に。",
    price: 2600,
    grad: "linear-gradient(135deg, #2a3340, #b6a05a)"
  }
];
...
const CART_KEY = "nihonbashi_sunaba_cart_v1";
