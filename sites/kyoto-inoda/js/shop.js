...
const PRODUCTS = [
  {
    id: "arabia-beans",
    name: "アラビアの真珠（コーヒー豆 200g）",
    desc: "創業以来の深煎りブレンド。ご家庭で京の一杯を。",
    price: 1300,
    grad: "radial-gradient(circle at 42% 32%, #c46a3a, #3a241a 72%)",
    note: "構成例（目安）"
  },
  {
    id: "drip-bag",
    name: "ドリップバッグ（10袋）",
    desc: "手軽に楽しめるドリップバッグ。贈り物にも。",
    price: 1200,
    grad: "radial-gradient(circle at 45% 35%, #a85432, #2a1812 72%)"
  },
  {
    id: "coffee-gift",
    name: "コーヒー 詰合せ（ギフト）",
    desc: "コーヒー豆とドリップの詰合せ。ご進物に。",
    price: 2600,
    grad: "linear-gradient(135deg, #3a241a, #c46a3a)"
  }
];
...
const CART_KEY = "kyoto_inoda_cart_v1";
