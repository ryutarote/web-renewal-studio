...
(function () {
  ...
  const DESC = {
    home:  "仙台牛たん焼“発祥の店”「味太助」（リニューアル提案）。昭和23年に初代・佐野啓四郎が牛たん焼を創案。仙台市青葉区一番町。名物の牛たん焼・テールスープ・麦飯。牛たん塩味のお取り寄せも。",
    menu:  "味太助のお品書き。名物の牛たん焼、テールスープ、麦飯、南蛮味噌漬。炭火で香ばしく焼き上げる仙台牛たんの定番。価格はすべて目安です。",
    story: "味太助の物語。昭和23年（1948年）、初代・佐野啓四郎が仙台で牛たん焼を創案。発祥の店として受け継ぐ味と、炭火焼のこだわりをご紹介します。",
    shop:  "味太助の店舗情報・アクセス。〒980-0811 宮城県仙台市青葉区一番町四丁目4-13／022-225-4641。定休は火曜。",
    order: "味太助のお取り寄せ。冷凍の牛たん塩味、テールスープ、進物用詰合せ。ご家庭で発祥の味を。アカウント登録不要のゲスト購入OK（デモ）。"
  };
  const views = $$(".view");
  ...
  function renderCart() {
    ...
    if (ids.length === 0) {
      cartItemsEl.innerHTML = `<div class="cart-empty"><p>カートは空です。<br>発祥の味、牛たん塩味のお取り寄せはいかがですか？</p><a class="btn btn-primary" href="#/order">お取り寄せを見る</a></div>`;
    } else {
