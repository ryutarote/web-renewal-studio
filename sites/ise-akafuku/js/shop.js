...
const PRODUCTS = [
  {
    id: "akafuku-8",
    name: "赤福餅 折箱（8個）",
    desc: "なめらかなこし餡とやわらかな餅。お伊勢参りの定番をご家庭に。",
    price: 900,
    grad: "radial-gradient(circle at 42% 32%, #e0b24a, #8a2a3a 72%)",
    note: "構成例（目安）"
  },
  {
    id: "akafuku-12",
    name: "赤福餅 折箱（12個）",
    desc: "ご家族やお集まりに。つくりたての風味を。",
    price: 1300,
    grad: "radial-gradient(circle at 45% 35%, #b6324a, #6a1f2c 72%)"
  },
  {
    id: "akafuku-gift",
    name: "赤福餅 詰合せ（ギフト）",
    desc: "季節の菓子とあわせた詰合せ。ご進物に。",
    price: 2200,
    grad: "linear-gradient(135deg, #8a2a3a, #e0b24a)"
  }
];
...
const CART_KEY = "ise_akafuku_cart_v1";
