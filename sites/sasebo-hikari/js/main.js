...
(function () {
  ...
  const DESC = {
    home:  "佐世保バーガーの老舗「ハンバーガーショップ ヒカリ」（リニューアル提案）。昭和26年創業。注文を受けてから作る、ジューシーな手ごねパティと甘めのマヨネーズ。米軍基地の街・佐世保で育った手作りバーガーを。",
    menu:  "ヒカリのお品書き。ハンバーガー、チーズバーガー、スペシャルバーガーなど。価格は税込・目安です。佐世保。",
    story: "ヒカリの歩み。昭和26年創業。米軍基地の街・佐世保で、手作りのハンバーガーを供してきた老舗。",
    shop:  "ハンバーガーショップ ヒカリ 本店の店舗情報・アクセス。長崎県佐世保市矢岳町1-1／0956-25-6685。",
    order: "ヒカリのお取り寄せ（提案デモ）。バーガーソースや冷凍パティなど、家庭で味わう構成例。"
  };
  const views = $$(".view");
  ...
  function renderCart() {
    ...
    if (ids.length === 0) {
      cartItemsEl.innerHTML = `<div class="cart-empty"><p>カートは空です。<br>佐世保バーガーセットはいかがですか？</p><a class="btn btn-primary" href="#/order">お取り寄せを見る</a></div>`;
    } else {
