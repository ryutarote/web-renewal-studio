...
(function () {
  ...
  const DESC = {
    home:  "広島つけ麺の名店「廣島つけ麺本舗 ばくだん屋」（リニューアル提案）。冷たい細麺と、辛味と酸味が一体となったつけだれ。キャベツやネギ、ゆで卵とともに。辛さは0から100倍以上まで選べます。",
    menu:  "ばくだん屋のお品書き。広島つけ麺（並・大盛）、辛さ選択など。価格は税込・目安です。広島。",
    story: "ばくだん屋の歩み。広島つけ麺を広島のご当地麺として広めた名店。辛味と酸味のつけだれが身上。",
    shop:  "廣島つけ麺本舗 ばくだん屋 本店の店舗情報・アクセス。広島市中区流川町／082-546-0089。",
    order: "ばくだん屋のお取り寄せ（提案デモ）。広島つけ麺の通販など、家庭で味わう構成例。"
  };
  const views = $$(".view");
  ...
  function renderCart() {
    ...
    if (ids.length === 0) {
      cartItemsEl.innerHTML = `<div class="cart-empty"><p>カートは空です。<br>通販の広島つけ麺はいかがですか？</p><a class="btn btn-primary" href="#/order">お取り寄せを見る</a></div>`;
    } else {
