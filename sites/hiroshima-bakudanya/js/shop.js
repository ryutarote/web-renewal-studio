...
const PRODUCTS = [
  {
    id: "tsukemen",
    name: "広島つけ麺（通販・3食）",
    desc: "冷たい細麺と辛味・酸味のつけだれのセット。家庭で広島つけ麺を。",
    price: 1500,
    grad: "radial-gradient(circle at 42% 32%, #e0823a, #2a1414 72%)",
    note: "構成例（目安）"
  },
  {
    id: "tsukedare",
    name: "つけだれ",
    desc: "辛味と酸味のつけだれ。麺や野菜に。",
    price: 700,
    grad: "radial-gradient(circle at 45% 35%, #b6322a, #1e1010 72%)"
  },
  {
    id: "karami",
    name: "辛みそ",
    desc: "辛さを足す辛みそ。お好みで調整を。",
    price: 600,
    grad: "linear-gradient(135deg, #2a1414, #e0823a)"
  }
];
...
const CART_KEY = "hiroshima_bakudanya_cart_v1";
