...
const PRODUCTS = [
  {
    id: "warishita",
    name: "親子丼の割下（たれ）",
    desc: "鶏のだしを生かした親子丼用の割下。ご家庭の卵と鶏肉で“あの一杯”を。",
    price: 1200,
    grad: "radial-gradient(circle at 42% 32%, #d8a23a, #6a1717 72%)",
    note: "構成例（目安）"
  },
  {
    id: "tori-soup",
    name: "地鶏スープ（親子丼用）",
    desc: "澄んだ鶏のだし。親子丼はもちろん、雑炊や鍋にも。",
    price: 1500,
    grad: "radial-gradient(circle at 45% 35%, #e2b24a, #7a1f1f 72%)"
  },
  {
    id: "oyako-set",
    name: "親子丼セット（具材＋割下）",
    desc: "鶏肉・割下・薬味の詰合せ。卵とご飯をご用意いただくだけ。",
    price: 3200,
    grad: "linear-gradient(135deg, #6a1717, #d8a23a)"
  }
];
...
const CART_KEY = "tokyo_tamahide_cart_v1";
