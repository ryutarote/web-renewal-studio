...
(function () {
  ...
  const DESC = {
    home:  "仙台・本町の牛たん炭火焼「たん焼き 山梨」（リニューアル提案）。厚切りのたん焼きを一枚ずつ炭火で。名物ヤマちゃんラーメンは17時から。テールスープ・とろろ・麦めしとともに。お取り寄せも。",
    menu:  "たん焼き 山梨のお品書き。炭火で焼く厚切りたん焼き定食、テールスープ、とろろ、麦めし。17時からの名物ヤマちゃんラーメン¥630。仙台市青葉区本町。",
    story: "たん焼き 山梨のこだわり。一枚ずつ炭火で焼き上げる厚切りの牛たん。仙台牛たんの流儀と、テールスープ・麦めしの定食スタイルをご紹介します。",
    shop:  "たん焼き 山梨の店舗情報・アクセス。宮城県仙台市青葉区本町2-17-21 セリザワビル1F／022-262-1621。営業11:30〜14:30・17:00〜22:00、定休 日曜・祝日。",
    order: "たん焼き 山梨のお取り寄せ。厚切り牛たん（塩・味噌漬け）やテールスープをご家庭で。アカウント登録不要のゲスト購入OK（デモ）。"
  };
  const views = $$(".view");
  ...
  function renderCart() {
    ...
    if (ids.length === 0) {
      cartItemsEl.innerHTML = `<div class="cart-empty"><p>カートは空です。<br>厚切り牛たんのお取り寄せはいかがですか？</p><a class="btn btn-primary" href="#/order">お取り寄せを見る</a></div>`;
    } else {
