...
const PRODUCTS = [
  {
    id: "tsuhan-kuma",
    name: "熊本ラーメン（通販・3食）",
    desc: "あっさり豚骨と焦がしにんにくのセット。家庭で王様ラーメンを。",
    price: 1500,
    grad: "radial-gradient(circle at 42% 32%, #e0c44a, #2a2230 72%)",
    note: "構成例（目安）"
  },
  {
    id: "mayu",
    name: "焦がしにんにく油（マー油）",
    desc: "香ばしいマー油。ラーメンやチャーハンの仕上げに。",
    price: 700,
    grad: "radial-gradient(circle at 45% 35%, #b09a3a, #221c28 72%)"
  },
  {
    id: "kuma-set",
    name: "王様ラーメンセット（2食）",
    desc: "看板の王様ラーメンを家庭で。マー油付き。",
    price: 1200,
    grad: "linear-gradient(135deg, #2a2230, #e0c44a)"
  }
];
...
const CART_KEY = "kumamoto_komurasaki_cart_v1";
