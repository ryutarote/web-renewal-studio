...
(function () {
  ...
  const DESC = {
    home:  "佐賀ちゃんぽんの名店「井手ちゃんぽん 本店」（リニューアル提案）。山盛りの野菜と豚骨ベースのまろやかなスープ、もちもちの麺。佐賀・武雄で愛される、ボリューム満点のちゃんぽんを。",
    menu:  "井手ちゃんぽんのお品書き。チャンポン、めん大盛・野菜大盛、皿うどんなど。価格は税込・目安です。佐賀・武雄。",
    story: "井手ちゃんぽんの歩み。佐賀・武雄で創業。山盛り野菜のちゃんぽんを佐賀の名物として広めた老舗。",
    shop:  "井手ちゃんぽん 本店の店舗情報・アクセス。佐賀県武雄市北方町大字志久1928／0954-36-2047。",
    order: "井手ちゃんぽんのお取り寄せ（提案デモ）。ちゃんぽんの通販など、家庭で味わう構成例。"
  };
  const views = $$(".view");
  ...
  function renderCart() {
    ...
    if (ids.length === 0) {
      cartItemsEl.innerHTML = `<div class="cart-empty"><p>カートは空です。<br>通販のちゃんぽんはいかがですか？</p><a class="btn btn-primary" href="#/order">お取り寄せを見る</a></div>`;
    } else {
