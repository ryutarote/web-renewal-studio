...
const PRODUCTS = [
  {
    id: "inaniwa",
    name: "稲庭うどん（乾麺・360g）",
    desc: "手綯いの稲庭うどん。つるりとした喉ごしをご家庭で。",
    price: 1400,
    grad: "radial-gradient(circle at 42% 32%, #d8c47a, #1e3a52 72%)",
    note: "構成例（目安）"
  },
  {
    id: "futsuyu",
    name: "二味つゆ（しょうゆ・ごま）",
    desc: "せいろ用の二味つゆ。喉ごしを引き立てます。",
    price: 800,
    grad: "radial-gradient(circle at 45% 35%, #3a5a72, #142838 72%)"
  },
  {
    id: "inaniwa-gift",
    name: "稲庭うどん 詰合せ（ギフト）",
    desc: "うどんとつゆの詰合せ。ご進物に。",
    price: 3200,
    grad: "linear-gradient(135deg, #1e3a52, #d8c47a)"
  }
];
...
const CART_KEY = "akita_satoyosuke_cart_v1";
