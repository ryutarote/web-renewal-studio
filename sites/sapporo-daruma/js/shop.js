...
const PRODUCTS = [
  {
    id: "lamb",
    name: "生ラム肉（冷凍・400g）",
    desc: "クセの少ない生ラム。フライパンや鍋で、タレをつけて。",
    price: 2200,
    grad: "radial-gradient(circle at 42% 32%, #e89a3a, #2a1812 72%)",
    note: "構成例（目安）"
  },
  {
    id: "daruma-tare",
    name: "だるま秘伝のタレ",
    desc: "焼いた肉につける秘伝のタレ。野菜炒めにも。",
    price: 700,
    grad: "radial-gradient(circle at 45% 35%, #c47a2f, #221410 72%)"
  },
  {
    id: "jingis-set",
    name: "ジンギスカンセット（肉＋タレ）",
    desc: "ラム肉とタレの詰合せ。家庭でだるまの味を。",
    price: 3000,
    grad: "linear-gradient(135deg, #2a1812, #e89a3a)"
  }
];
...
const CART_KEY = "sapporo_daruma_cart_v1";
