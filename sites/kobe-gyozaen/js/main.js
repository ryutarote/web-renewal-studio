...
(function () {
  ...
  const DESC = {
    home:  "神戸・味噌だれ餃子発祥の店「元祖 ぎょうざ苑」（リニューアル提案）。昭和26年創業。一子相伝の秘伝味噌だれでいただく、神戸のご当地餃子。南京町の老舗専門店で。",
    menu:  "元祖 ぎょうざ苑のお品書き。味噌だれ餃子、焼飯など。価格は税込・目安です。神戸・南京町。",
    story: "ぎょうざ苑の歩み。昭和26年創業。神戸味噌だれ餃子の発祥店として、秘伝の味噌だれを受け継ぐ専門店。",
    shop:  "元祖 ぎょうざ苑の店舗情報・アクセス。神戸市中央区栄町通（南京町）。JR元町駅すぐ。定休 月曜。",
    order: "ぎょうざ苑のお取り寄せ（提案デモ）。冷凍餃子や秘伝味噌だれなど、家庭で味わう構成例。"
  };
  const views = $$(".view");
  ...
  function renderCart() {
    ...
    if (ids.length === 0) {
      cartItemsEl.innerHTML = `<div class="cart-empty"><p>カートは空です。<br>冷凍餃子や秘伝の味噌だれはいかがですか？</p><a class="btn btn-primary" href="#/order">お取り寄せを見る</a></div>`;
    } else {
