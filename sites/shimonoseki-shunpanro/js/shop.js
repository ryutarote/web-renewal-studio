...
const PRODUCTS = [
  {
    id: "fugu-sashi",
    name: "ふぐ刺し（冷凍・2人前）",
    desc: "本場下関のてっさを薄造りで。器に並べてご家庭の食卓に。",
    price: 6500,
    grad: "radial-gradient(circle at 42% 32%, #cdb45a, #142b40 72%)",
    note: "構成例（目安）"
  },
  {
    id: "fugu-nabe",
    name: "ふぐちり鍋セット",
    desc: "ふぐの身とアラ、出汁のセット。締めの雑炊まで。",
    price: 8800,
    grad: "radial-gradient(circle at 45% 35%, #2a4a66, #102234 72%)"
  },
  {
    id: "fugu-zosui",
    name: "ふぐ雑炊セット",
    desc: "ふぐ出汁の雑炊を手軽に。〆の一杯を家庭でも。",
    price: 1800,
    grad: "linear-gradient(135deg, #16314a, #cdb45a)"
  }
];
...
const CART_KEY = "shimonoseki_shunpanro_cart_v1";
