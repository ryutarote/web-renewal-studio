...
const PRODUCTS = [
  {
    id: "hanton-sauce",
    name: "ハントンライスソース（ケチャップ＆タルタル）",
    desc: "名物の味を再現するソースセット。卵料理やフライにも。",
    price: 900,
    grad: "radial-gradient(circle at 42% 32%, #e8b84a, #4a2f1a 72%)",
    note: "構成例（目安）"
  },
  {
    id: "frozen-fry",
    name: "冷凍フライ（エビ・カジキ）",
    desc: "揚げるだけのフライ。ハントンライスやお弁当に。",
    price: 1600,
  ...
  },
  {
    id: "hanton-set",
    name: "ハントンライスセット",
    desc: "ソースとフライの詰合せ。家庭で金沢洋食を。",
    price: 2400,
    grad: "linear-gradient(135deg, #4a2f1a, #e8b84a)"
  }
];
...
const CART_KEY = "kanazawa_otsuka_cart_v1";
