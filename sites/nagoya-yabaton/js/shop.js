...
const PRODUCTS = [
  {
    id: "misodare",
    name: "みそかつのたれ",
    desc: "熟成豆味噌の特製だれ。とんかつや田楽、おでんにも。",
    price: 900,
    grad: "radial-gradient(circle at 42% 32%, #d99a3a, #3a2417 72%)",
    note: "構成例（目安）"
  },
  {
    id: "frozen-katsu",
    name: "冷凍ロースカツ 4枚",
    desc: "揚げるだけのロースカツ。みそだれをかけて名物の味に。",
    price: 1800,
    grad: "radial-gradient(circle at 45% 35%, #b56a32, #2a1a10 72%)"
  },
  {
    id: "misokatsu-set",
    name: "みそかつセット（カツ＋たれ）",
    desc: "カツとみそだれの詰合せ。ご家庭でみそかつを手軽に。",
    price: 2600,
    grad: "linear-gradient(135deg, #3a2417, #d99a3a)"
  }
];
...
const CART_KEY = "nagoya_yabaton_cart_v1";
