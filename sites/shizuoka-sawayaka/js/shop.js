...
const PRODUCTS = [
  {
    id: "genkotsu",
    name: "げんこつハンバーグ（冷凍・4個）",
    desc: "牛肉の旨みを閉じ込めたハンバーグ。焼いてご家庭で。",
    price: 2400,
    grad: "radial-gradient(circle at 42% 32%, #e89a3a, #2a1d16 72%)",
    note: "構成例（目安）"
  },
  {
    id: "hb-sauce",
    name: "オニオン／デミグラスソース",
    desc: "ハンバーグ用ソースのセット。お好みで。",
    price: 700,
    grad: "radial-gradient(circle at 45% 35%, #c47a2f, #221610 72%)"
  },
  {
    id: "hb-set",
    name: "ハンバーグセット（ソース付）",
    desc: "ハンバーグとソースの詰合せ。家庭でさわやかの味を。",
    price: 3000,
    grad: "linear-gradient(135deg, #2a1d16, #e89a3a)"
  }
];
...
const CART_KEY = "shizuoka_sawayaka_cart_v1";
