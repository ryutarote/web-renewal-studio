...
const PRODUCTS = [
  {
    id: "retort-indo",
    name: "純印度式カリー（レトルト）",
    desc: "香り高い本格インドカリーをご家庭で。温めるだけ。",
    price: 650,
    grad: "radial-gradient(circle at 42% 32%, #e0a23a, #6a2f1a 72%)",
    note: "構成例（目安）"
  },
  {
    id: "curry-set",
    name: "インドカリー詰合せ",
    desc: "数種のカリーの詰合せ。常備やギフトに。",
    price: 2400,
  ...
  },
  {
    id: "naan",
    name: "ナン＆カリーセット",
    desc: "カリーに合うナンのセット。手軽に本格気分。",
    price: 1500,
    grad: "linear-gradient(135deg, #6a2f1a, #e0a23a)"
  }
];
...
const CART_KEY = "shinjuku_nakamuraya_cart_v1";
