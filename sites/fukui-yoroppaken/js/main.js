...
(function () {
  ...
  const DESC = {
    home:  "福井名物ソースカツ丼の元祖「ヨーロッパ軒 総本店」（リニューアル提案）。大正2年創業、ドイツ仕込みの特製ソースときめ細かな衣。総本店は福井市順化。特製ソース＆パン粉のお取り寄せも。",
    menu:  "ヨーロッパ軒 総本店のお品書き。元祖ソースカツ丼、パリ丼、ミックス丼、各種セット。きめ細かなパン粉の軽い衣を特製ソースでくぐらせた福井名物。価格は税込。",
    story: "ヨーロッパ軒の物語。大正2年、創業者・高畠増太郎がドイツ仕込みの料理を「カツ丼」として発表。福井に根づいた元祖ソースカツ丼の歴史と、おいしさの秘密。",
    shop:  "ヨーロッパ軒 総本店の店舗情報・アクセス。福井県福井市順化1-7-4／0776-21-4681。JR福井駅から徒歩約10分。県内ののれん分け店についても。",
    order: "ヨーロッパ軒のお取り寄せ。特製カツ丼ソース＆極細パン粉の詰合せ。ご家庭で元祖の味を再現。アカウント登録不要のゲスト購入OK（デモ）。"
  };
  const views = $$(".view");
