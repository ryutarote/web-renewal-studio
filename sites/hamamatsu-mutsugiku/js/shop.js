...
const PRODUCTS = [
  {
    id: "hamamatsu-gyoza",
    name: "冷凍浜松餃子（24個）",
    desc: "野菜たっぷりのあっさり餡。焼いてもやしを添えてご家庭で。",
    price: 1200,
    grad: "radial-gradient(circle at 42% 32%, #e0a83a, #3a2218 72%)",
    note: "構成例（目安）"
  },
  {
    id: "gyoza-tare",
    ...
    desc: "酢醤油ベースの餃子用タレ。",
    price: 600,
    grad: "radial-gradient(circle at 45% 35%, #c4882f, #2a1812 72%)"
  },
  {
    id: "gyoza-set-h",
    name: "浜松餃子セット（48個）",
    desc: "たっぷりの冷凍餃子。お集まりやお取り寄せに。",
    price: 2200,
    grad: "linear-gradient(135deg, #3a2218, #e0a83a)"
  }
];
...
const CART_KEY = "hamamatsu_mutsugiku_cart_v1";
