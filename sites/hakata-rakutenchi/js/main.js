...
(function () {
  ...
  const DESC = {
    home:  "福岡・博多のもつ鍋元祖「元祖もつ鍋 楽天地」（リニューアル提案）。大将厳選6種の新鮮な生もつ、女将特製の秘伝スープ、メガ盛りのニラ・キャベツ。一種類のもつ鍋だけにこだわる元祖の味。もつ鍋セットのお取り寄せも。",
    menu:  "元祖もつ鍋 楽天地のお品書き。6種の生もつと秘伝スープ、メガ盛りのニラ・キャベツの元祖もつ鍋、追加生もつ、ちゃんぽん〆や雑炊など。価格は税込・目安。",
    story: "楽天地の物語。福岡・博多で「元祖もつ鍋」を掲げ、たった一種類のもつ鍋だけにこだわる店。大将厳選の生もつ、女将特製の秘伝スープ、メガ盛り野菜のおいしさの秘密。",
    shop:  "元祖もつ鍋 楽天地の店舗情報・アクセス。福岡県福岡市中央区今泉1-19-18／092-738-1767。西鉄天神駅から徒歩約3分。天神・大名・中洲などの各店についても。",
    order: "元祖もつ鍋 楽天地のお取り寄せ。新鮮な生もつ・秘伝スープ・ちゃんぽん玉のもつ鍋セット。ご家庭で元祖の味を再現。アカウント登録不要のゲスト購入OK（デモ）。"
  };
  const views = $$(".view");
  ...
  function renderCart() {
    ...
    if (ids.length === 0) {
      cartItemsEl.innerHTML = `<div class="cart-empty"><p>カートは空です。<br>元祖もつ鍋セットのお取り寄せはいかがですか？</p><a class="btn btn-primary" href="#/order">お取り寄せを見る</a></div>`;
    } else {
