...
(function () {
  ...
  const DESC = {
    home:  "大阪・新世界の串カツ発祥の店「串かつだるま」（リニューアル提案）。昭和4年（1929年）創業、サクッと軽い衣と秘伝ソース。総本店は大阪市浪速区恵美須東。名物どて焼きのお取り寄せも。ソース二度づけ禁止。",
    menu:  "串かつだるまのお品書き。元祖串かつ、どて焼き、海老など串かつ各種。サクッと軽い衣を秘伝ソースにくぐらせた大阪名物。ソース二度づけ禁止。価格は税込・目安。",
    story: "串かつだるまの歴史。昭和4年（1929年）、大阪・新世界で生まれた串カツ発祥の店。庶民に愛され続ける味と、ソース二度づけ禁止の文化のはじまり。",
    shop:  "串かつだるま 新世界総本店の店舗情報・アクセス。大阪市浪速区恵美須東。地下鉄動物園前駅・JR新今宮駅すぐ。大阪市内ほか複数店舗を展開。",
    order: "串かつだるまのお取り寄せ。名物どて焼き（レトルト）や秘伝ソース、進物用詰合せをお届け。アカウント登録不要のゲスト購入OK（デモ）。"
  };
  const views = $$(".view");
