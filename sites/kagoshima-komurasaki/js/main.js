...
(function () {
  ...
  const DESC = {
    home:  "鹿児島ラーメンの老舗「ラーメン専門 こむらさき」（リニューアル提案）。昭和25年創業。コクがありながらあっさりの豚骨スープに、どっさりのキャベツと鹿児島県産黒豚のチャーシュー。天文館の名店で。",
    menu:  "こむらさきのお品書き。ラーメン、チャーシューメンなど。価格は税込・目安です。鹿児島・天文館。",
    story: "こむらさきの歩み。昭和25年創業。オープンキッチンのスタイルを守り続ける、鹿児島ラーメンの老舗。",
    shop:  "ラーメン専門 こむらさき 天文館本店の店舗情報・アクセス。鹿児島県鹿児島市東千石町11-19／099-222-5707。",
    order: "こむらさきのお取り寄せ（提案デモ）。鹿児島ラーメンの通販など、家庭で味わう構成例。"
  };
  const views = $$(".view");
  ...
  function renderCart() {
    ...
    if (ids.length === 0) {
      cartItemsEl.innerHTML = `<div class="cart-empty"><p>カートは空です。<br>通販の鹿児島ラーメンはいかがですか？</p><a class="btn btn-primary" href="#/order">お取り寄せを見る</a></div>`;
    } else {
