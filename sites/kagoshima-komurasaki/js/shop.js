...
const PRODUCTS = [
  {
    id: "kagoshima-ramen",
    name: "鹿児島ラーメン（通販・3食）",
    desc: "あっさり豚骨スープと麺のセット。キャベツを加えてご家庭で。",
    price: 1500,
    grad: "radial-gradient(circle at 42% 32%, #e0a83a, #2a2018 72%)",
    note: "構成例（目安）"
  },
  {
    id: "kurobuta-cha",
    name: "黒豚チャーシュー",
    desc: "鹿児島県産黒豚の自家製チャーシュー。ラーメンやご飯に。",
    price: 1400,
    grad: "radial-gradient(circle at 45% 35%, #c4882f, #1f1812 72%)"
  },
  {
    id: "kago-soup",
    name: "豚骨スープ",
    desc: "コクがありながらあっさりの豚骨スープ。",
    price: 700,
    grad: "linear-gradient(135deg, #2a2018, #e0a83a)"
  }
];
...
const CART_KEY = "kagoshima_komurasaki_cart_v1";
