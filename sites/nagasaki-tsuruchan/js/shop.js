...
const PRODUCTS = [
  {
    id: "turkey-sauce",
    name: "トルコライスソース（カレー＆デミ）",
    desc: "カツにかけるソースのセット。家庭でトルコライスを。",
    price: 900,
    grad: "radial-gradient(circle at 42% 32%, #e8c44a, #6a2f22 72%)",
    note: "構成例（目安）"
  },
  {
    id: "napolitan",
    name: "ナポリタンソース",
    desc: "懐かしい喫茶店の味のナポリタンソース。",
    price: 700,
    grad: "radial-gradient(circle at 45% 35%, #c84a2f, #4a201a 72%)"
  },
  {
    id: "turkey-set",
    name: "トルコライスセット",
    desc: "ソース・パスタの詰合せ。一皿で大満足の味を家庭で。",
    price: 1800,
    grad: "linear-gradient(135deg, #6a2f22, #e8c44a)"
  }
];
...
const CART_KEY = "nagasaki_tsuruchan_cart_v1";
