...
const PRODUCTS = [
  {
    id: "akashiyaki",
    name: "明石焼（冷凍・2人前）",
    desc: "ふわとろの明石焼と出汁のセット。温めてご家庭で。",
    price: 1600,
    grad: "radial-gradient(circle at 42% 32%, #e8c44a, #1e3a44 72%)",
    note: "構成例（目安）"
  },
  {
    id: "akashi-dashi",
    name: "明石焼のだし",
    desc: "明石焼にひたすあたたかい出汁。うどんにも。",
    price: 700,
    grad: "radial-gradient(circle at 45% 35%, #2a5a64, #122a32 72%)"
  },
  {
    id: "akashiyaki-set",
    name: "明石焼セット（4人前）",
    desc: "たっぷりの明石焼と出汁。お集まりやお取り寄せに。",
    price: 2800,
    grad: "linear-gradient(135deg, #1e3a44, #e8c44a)"
  }
];
...
const CART_KEY = "akashi_takoiso_cart_v1";
