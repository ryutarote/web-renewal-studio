...
const PRODUCTS = [
  {
    id: "tsuhan-ramen",
    name: "大砲ラーメン（通販・3食）",
    desc: "呼び戻しスープと麺のセット。久留米とんこつをご家庭で。",
    price: 1500,
    grad: "radial-gradient(circle at 42% 32%, #e0a83a, #2a1d16 72%)",
    note: "構成例（目安）"
  },
  {
    id: "kaedama",
    name: "替玉セット（5玉）",
    desc: "スープを最後まで楽しむための替玉。",
    price: 800,
    grad: "radial-gradient(circle at 45% 35%, #c4882f, #241812 72%)"
  },
  {
    id: "mukashi-set",
    name: "昔ラーメンセット（2食）",
    desc: "屋台の味を再現した昔ラーメンのセット。",
    price: 1300,
    grad: "linear-gradient(135deg, #2a1d16, #e0a83a)"
  }
];
...
const CART_KEY = "kurume_taiho_cart_v1";
