...
const PRODUCTS = [
  {
    id: "reimen",
    name: "盛岡冷麺（通販・2食）",
    desc: "コシの強い麺とスープ、キムチのセット。家庭で盛岡冷麺を。",
    price: 1500,
    grad: "radial-gradient(circle at 42% 32%, #e0823a, #16323e 72%)",
    note: "構成例（目安）"
  },
  {
    id: "kimchi",
    name: "キムチ",
    desc: "冷麺に添える自家製キムチ。辛みの調整に。",
    price: 700,
    grad: "radial-gradient(circle at 45% 35%, #b6322a, #142a34 72%)"
  },
  {
    id: "reimen-set",
    name: "盛岡冷麺セット（4食）",
    desc: "たっぷりの冷麺セット。お集まりやお取り寄せに。",
    price: 2800,
    grad: "linear-gradient(135deg, #16323e, #e0823a)"
  }
];
...
const CART_KEY = "morioka_pyonpyon_cart_v1";
