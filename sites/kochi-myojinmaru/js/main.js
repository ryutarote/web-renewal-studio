...
(function () {
  ...
  const DESC = {
    home:  "“塩たたき”発祥の店「藁焼き鰹たたき 明神丸」（リニューアル提案）。運営は明神水産。藁焼きのライブパフォーマンスが名物。1号店は高知・ひろめ市場店。藁焼き鰹たたき／塩たたきのお取り寄せも全国発送。",
    menu:  "藁焼き鰹たたき 明神丸のお品書き。発祥の塩たたき、定番のタレたたき、各種定食。一本釣りの鰹を藁の炎で香ばしく焼き上げる土佐の名物。価格は目安。",
    story: "明神丸の物語。土佐の一本釣り漁師に始まる明神水産が、藁焼き鰹たたきと“塩たたき”を世に広めるまで。ひろめ市場の店先で見せる藁焼きのライブパフォーマンス。",
    shop:  "藁焼き鰹たたき 明神丸の店舗情報・アクセス。1号店は高知県高知市帯屋町2-3-1 ひろめ市場内。JR高知駅・はりまや橋から徒歩圏。営業時間・通販のご案内。",
    order: "明神丸（明神水産）のお取り寄せ。藁焼き鰹 塩たたき・タレたたきセットを全国へクール便発送。ご家庭で土佐の味を。アカウント登録不要のゲスト購入OK（デモ）。"
  };
  const views = $$(".view");
  ...
  function renderCart() {
    ...
    if (ids.length === 0) {
      cartItemsEl.innerHTML = `<div class="cart-empty"><p>カートは空です。<br>藁焼き鰹たたき・塩たたきのお取り寄せはいかがですか？</p><a class="btn btn-primary" href="#/order">お取り寄せを見る</a></div>`;
    } else {
