...
(function () {
  ...
  const DESC = {
    home:  "盛岡・内丸の「白龍（パイロン）本店」。昭和28年創業、盛岡じゃじゃ麺発祥の店。秘伝の肉味噌ともちもち平打ち麺、締めのちーたんたん。",
    menu:  "白龍のメニュー。じゃじゃ麺（大・中・小）、締めのちーたんたん、水餃子・焼餃子など。じゃじゃ麺中550円、ちーたんたん50円。",
    story: "盛岡じゃじゃ麺発祥の店・白龍の物語。昭和28年、満州の炸醤麺を盛岡風にアレンジ。屋台から愛されてきた一杯。",
    shop:  "白龍（パイロン）本店の店舗・アクセス。盛岡市内丸5-15。月〜土9:00〜21:00、日11:30〜16:00。",
    order: "白龍のお取り寄せ（じゃじゃ麺・デモ）。アカウント登録不要のゲスト購入OK。"
  };
  const views = $$(".view");
  ...
  function renderCart() {
    ...
    if (ids.length === 0) {
      cartItemsEl.innerHTML = `<div class="cart-empty"><p>カートは空です。<br>じゃじゃ麺のお取り寄せはいかがですか？</p><a class="btn btn-primary" href="#/order">お取り寄せを見る</a></div>`;
    } else {
