...
const PRODUCTS = [
  {
    id: "curry-ramen",
    name: "カレーラーメン（通販・3食）",
    desc: "とろみのカレースープと中太ちぢれ麺のセット。家庭で室蘭の味を。",
    price: 1500,
    grad: "radial-gradient(circle at 42% 32%, #e0902f, #4a2e12 72%)",
    note: "構成例（目安）"
  },
  {
    id: "curry-soup",
    name: "カレースープ",
    desc: "スパイスの効いたカレースープ。麺や鍋に。",
    price: 800,
    grad: "radial-gradient(circle at 45% 35%, #c47a2f, #3a2410 72%)"
  },
  {
    id: "curry-set",
    name: "カレーラーメンセット（具材付）",
    ...
    price: 2400,
    grad: "linear-gradient(135deg, #4a2e12, #e0902f)"
  }
];
...
const CART_KEY = "muroran_daiou_cart_v1";
