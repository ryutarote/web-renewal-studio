...
const PRODUCTS = [
  {
    id: "steak-sauce",
    name: "ステーキソース",
    desc: "赤身ステーキに合うジャッキー仕立てのソース。家庭の焼き肉にも。",
    price: 780,
    grad: "radial-gradient(circle at 42% 32%, #e0b24a, #8a1f1f 72%)",
    note: "構成例（目安）"
  },
  {
    id: "tacorice",
    name: "タコライスの素 2食",
    desc: "スパイシーなミートソース。ごはんとレタス・チーズで沖縄の定番に。",
    price: 1200,
    grad: "radial-gradient(circle at 45% 35%, #c43a2a, #6a1717 72%)"
  },
  {
    id: "hamburg-sauce",
    name: "沖縄ハンバーグソース",
    desc: "ハンバーグステーキ用の特製ソース。",
    price: 780,
    grad: "linear-gradient(135deg, #8a1f1f, #e0b24a)"
  }
];
...
const CART_KEY = "naha_jackys_cart_v1";
