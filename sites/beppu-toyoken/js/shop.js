...
const PRODUCTS = [
  {
    id: "toriten-set",
    name: "本家とり天 詰合せ（冷凍）",
    desc: "卵衣のとり天を冷凍で。温めて発祥の味をご家庭で。",
    price: 2400,
    grad: "radial-gradient(circle at 42% 32%, #e0a83a, #5a2018 72%)",
    note: "構成例（目安）"
  },
  {
    id: "toriten-tare",
    name: "とり天の酢醤油だれ",
    desc: "とり天用の酢醤油。からしを添えてさっぱりと。",
    price: 600,
    grad: "radial-gradient(circle at 45% 35%, #c44a2a, #3a1410 72%)"
  },
  {
    id: "toriten-range",
    name: "レンジとり天",
    desc: "温めるだけのとり天。お弁当やおつまみに。",
    price: 1200,
    grad: "linear-gradient(135deg, #5a2018, #e0a83a)"
  }
];
...
const CART_KEY = "beppu_toyoken_cart_v1";
