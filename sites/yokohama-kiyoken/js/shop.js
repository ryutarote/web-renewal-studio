...
const PRODUCTS = [
  {
    id: "shumai-vacuum",
    name: "真空パックシウマイ（15個）",
    desc: "昔ながらのシウマイを真空パックで。常温保存でお土産にも。",
    price: 1200,
    grad: "radial-gradient(circle at 42% 32%, #e0b24a, #7a1f1f 72%)",
    note: "構成例（目安）"
  },
  {
    id: "shumai-gift",
    name: "シウマイ 詰合せ（ギフト）",
    desc: "シウマイ各種の詰合せ。ご進物に。",
    price: 2600,
  ...
  },
  {
    id: "getsupei",
    name: "月餅 詰合せ",
    desc: "お茶うけにうれしい中華菓子の詰合せ。",
    price: 1500,
    grad: "linear-gradient(135deg, #7a1f1f, #e0b24a)"
  }
];
...
const CART_KEY = "yokohama_kiyoken_cart_v1";
