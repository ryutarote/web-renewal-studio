...
(function () {
  ...
  const DESC = {
    home:  "沖縄そば 自家製生麺の店「東江そば（あがりえそば）」（リニューアル提案）。麺職人が独自配合で打つもちもちの自家製生麺と、国産昆布・鰹節の一番だし。本ソーキ・軟骨ソーキ・三枚肉そばが名物。生麺＋出汁の送料無料セットをお取り寄せで。",
    menu:  "東江そばのお品書き。看板のソーキそば、軟骨ソーキそば、三枚肉そば、沖縄そば。もちもちの自家製生麺に昆布・鰹節の一番だしを合わせた一杯。価格は税込・目安。",
    story: "東江そばのこだわり。麺職人が独自配合で打つ自家製生麺と、国産昆布・鰹節をふんだんに使った一番だし。麺・スープ・具が三位一体となる沖縄そば。",
    shop:  "東江そばの店舗情報・アクセス。沖縄県浦添市勢理客2-1-36（浦添本店）／098-879-5366。那覇市の小禄店についても。営業時間は目安。",
    order: "東江そばのお取り寄せ。自家製生麺と一番だしの送料無料セット、ソーキそば・三枚肉そばセットなど。ご家庭で店の味を。アカウント登録不要のゲスト購入OK（デモ）。"
  };
  const views = $$(".view");
  ...
  function renderCart() {
    ...
    if (ids.length === 0) {
      cartItemsEl.innerHTML = `<div class="cart-empty"><p>カートは空です。<br>自家製生麺＆出汁のお取り寄せはいかがですか？</p><a class="btn btn-primary" href="#/order">お取り寄せを見る</a></div>`;
    } else {
