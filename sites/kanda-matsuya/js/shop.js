...
const PRODUCTS = [
  {
    id: "namasoba",
    name: "生そば（3人前）",
    desc: "手打ちの風味を生そばで。つゆを添えてご家庭で。",
    price: 1500,
    grad: "radial-gradient(circle at 42% 32%, #b6a05a, #202a36 72%)",
    note: "構成例（目安）"
  },
  {
    id: "soba-tsuyu-m",
    name: "そばつゆ",
    desc: "返しの効いた辛汁。もり・かけに。",
    price: 800,
    grad: "radial-gradient(circle at 45% 35%, #44505c, #161e26 72%)"
  },
  {
    id: "soba-gift-m",
    name: "そば詰合せ（ギフト）",
    desc: "そばとつゆの詰合せ。ご進物に。",
    price: 2600,
    grad: "linear-gradient(135deg, #202a36, #b6a05a)"
  }
];
...
const CART_KEY = "kanda_matsuya_cart_v1";
