...
(function () {
  ...
  const DESC = {
    home:  "広島・八丁堀の「みっちゃん総本店 八丁堀本店」。昭和25年創業、広島風お好み焼の元祖。そば入り・お好みソース・ヘラ文化の生まれた店。",
    menu:  "みっちゃん総本店のお好み焼き。そば肉玉・うどん肉玉・スペシャル、夜は鉄板焼き（牡蠣・コウネ・ホルモン）も。",
    story: "広島風お好み焼の元祖・みっちゃん総本店の歴史。昭和25年、屋台から。そば入りやお好みソース、ヘラで食べる文化の発祥。",
    shop:  "みっちゃん総本店 八丁堀本店の店舗・アクセス。広島市中区八丁堀6-7。火曜定休。ランチ・ディナー営業。",
    order: "みっちゃん総本店のお取り寄せ（冷凍お好み焼き・デモ）。アカウント登録不要のゲスト購入OK。"
  };
  const views = $$(".view");
