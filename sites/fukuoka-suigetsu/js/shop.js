...
const PRODUCTS = [
  {
    id: "mizutaki-set",
    name: "博多水たきセット（2人前）",
    desc: "白濁スープと骨付き鶏・つくねのセット。家庭で発祥の水炊きを。",
    price: 5800,
    grad: "radial-gradient(circle at 42% 32%, #c8b86a, #16313a 72%)",
    note: "構成例（目安）"
  },
  {
    id: "tori-soup-s",
    name: "水たきスープ",
    desc: "鶏を炊き出した白濁スープ。鍋や雑炊に。",
    price: 1200,
    grad: "radial-gradient(circle at 45% 35%, #2a5a64, #0e2228 72%)"
  },
  {
    id: "tsukune",
    name: "鶏つくね",
    desc: "ふわりとした鶏つくね。水炊きの名脇役。",
    price: 900,
    grad: "linear-gradient(135deg, #16313a, #c8b86a)"
  }
];
...
const CART_KEY = "fukuoka_suigetsu_cart_v1";
