...
const PRODUCTS = [
  {
    id: "udonsuki",
    name: "権太呂鍋（うどんすき）セット",
    desc: "具材とだし、うどんのセット。京の出汁で炊いてご家庭で。",
    price: 4800,
    grad: "radial-gradient(circle at 42% 32%, #c8b86a, #1e3240 72%)",
    note: "構成例（目安）"
  },
  {
    id: "kyo-dashi",
    name: "京のだし",
    desc: "昆布と削り節の上品なだし。うどんや煮物に。",
    price: 900,
    grad: "radial-gradient(circle at 45% 35%, #2a4a5a, #142630 72%)"
  },
  {
    id: "udon-gift",
    name: "うどん 詰合せ（ギフト）",
    ...
    price: 2600,
    grad: "linear-gradient(135deg, #1e3240, #c8b86a)"
  }
];
...
const CART_KEY = "kyoto_gontaro_cart_v1";
