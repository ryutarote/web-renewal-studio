...
(function () {
  ...
  const DESC = {
    home:  "今治名物 焼豚玉子飯の「白楽天 今治本店」（リニューアル提案）。甘辛いタレをまとった焼豚と、とろりとした半熟玉子をごはんにのせて。まかないから生まれた今治のソウルフードを、中華の名店で。",
    menu:  "白楽天のお品書き。焼豚玉子飯、Aセット、中華一品など。価格は税込・目安です。今治。",
    story: "白楽天の歩み。今治の中華料理店のまかないから生まれた焼豚玉子飯を、看板メニューとして広めた名店。",
    shop:  "焼豚玉子飯 白楽天 今治本店の店舗情報・アクセス。愛媛県今治市（今治本店）。定休 火曜。",
    order: "白楽天のお取り寄せ（提案デモ）。焼豚玉子飯の素など、家庭で味わう構成例。"
  };
  const views = $$(".view");
  ...
  function renderCart() {
    ...
    if (ids.length === 0) {
      cartItemsEl.innerHTML = `<div class="cart-empty"><p>カートは空です。<br>焼豚玉子飯の素はいかがですか？</p><a class="btn btn-primary" href="#/order">お取り寄せを見る</a></div>`;
    } else {
