...
const PRODUCTS = [
  {
    id: "asahikawa-ramen",
    name: "旭川ラーメン（通販・3食）",
    desc: "魚介豚骨スープと焦がしラード、ちぢれ麺のセット。家庭で旭川の味を。",
    price: 1500,
    grad: "radial-gradient(circle at 42% 32%, #e0a83a, #2a1d12 72%)",
    note: "構成例（目安）"
  },
  {
    id: "hachiya-lard",
    name: "焦がしラード",
    desc: "香ばしい焦がしラード。ラーメンや炒め物に。",
    price: 700,
    grad: "radial-gradient(circle at 45% 35%, #c4882f, #241810 72%)"
  },
  {
    id: "asahikawa-set",
    name: "旭川ラーメンセット（具材付）",
    desc: "麺・スープ・チャーシューの詰合せ。家庭で名店の味を。",
    price: 2400,
    grad: "linear-gradient(135deg, #2a1d12, #e0a83a)"
  }
];
...
const CART_KEY = "asahikawa_hachiya_cart_v1";
