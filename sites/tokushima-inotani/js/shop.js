...
const PRODUCTS = [
  {
    id: "tokushima-ramen",
    name: "徳島ラーメン（通販・3食）",
    desc: "茶系の甘辛スープと中細麺のセット。生卵を添えて家庭で。",
    price: 1500,
    grad: "radial-gradient(circle at 42% 32%, #e0a83a, #2a1d14 72%)",
    note: "構成例（目安）"
  },
  {
    id: "butabara",
    name: "味付け豚バラ（具材）",
    desc: "すき焼き風に炊いたバラ肉。ラーメンやご飯に。",
    price: 1000,
  ...
  },
  {
    id: "ramen-set-t",
    name: "徳島ラーメンセット（具材付）",
    desc: "麺・スープ・バラ肉の詰合せ。家庭で名店の味を。",
    price: 2400,
    grad: "linear-gradient(135deg, #2a1d14, #e0a83a)"
  }
];
...
const CART_KEY = "tokushima_inotani_cart_v1";
