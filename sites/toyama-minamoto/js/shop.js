...
const PRODUCTS = [
  {
    id: "masu-ichi",
    name: "ますのすし（一重）",
    desc: "笹で包んだ定番のますのすし。富山の郷土寿しをご家庭で。",
    price: 1700,
    grad: "radial-gradient(circle at 42% 32%, #e0a84a, #1a3a2a 72%)",
    note: "構成例（目安）"
  },
  {
    id: "masu-tokusen",
  ...
  },
  {
    id: "masu-ni",
    name: "ますのすし（二重）",
    desc: "二段重ねのボリューム。お集まりに。",
    price: 3200,
    grad: "linear-gradient(135deg, #1a3a2a, #e0a84a)"
  }
];
...
const CART_KEY = "toyama_minamoto_cart_v1";
