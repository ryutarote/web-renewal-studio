...
const PRODUCTS = [
  {
    id: "nishin-soba",
    name: "にしんそば セット（2人前）",
    desc: "甘く炊いた身欠きにしんとそば・つゆのセット。京の名物を家庭で。",
    price: 2200,
    grad: "radial-gradient(circle at 42% 32%, #c8b86a, #1a3a2a 72%)",
    note: "構成例（目安）"
  },
  {
    id: "nishin",
    name: "身欠きにしん甘露煮",
    desc: "甘くふっくら炊いたにしん。そばやごはんに。",
    price: 1200,
    grad: "radial-gradient(circle at 45% 35%, #2a6a4a, #123022 72%)"
  },
  {
    id: "nishin-gift",
    name: "にしんそば 詰合せ（ギフト）",
    desc: "そばとにしんの詰合せ。ご進物に。",
    price: 3200,
    grad: "linear-gradient(135deg, #1a3a2a, #c8b86a)"
  }
];
...
const CART_KEY = "kyoto_matsuba_cart_v1";
