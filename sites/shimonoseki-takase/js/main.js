...
(function () {
  ...
  const DESC = {
    home:  "瓦そば発祥の店「元祖瓦そば たかせ」（リニューアル提案）。昭和37年創業。熱した瓦の上で焼いた茶そばに、錦糸卵・牛肉・もみじおろし・レモン。温かいつゆにつけて。山口・川棚温泉の名物です。",
    menu:  "たかせのお品書き。瓦そば、うなめし、定食など。価格は税込・目安です。山口・川棚温泉。",
    story: "たかせの歩み。昭和37年創業。西南戦争の野戦の逸話から瓦で焼くそばを考案し、瓦そばを生んだ老舗。",
    shop:  "元祖瓦そば たかせ 川棚本館の店舗情報・アクセス。山口県下関市豊浦町川棚5429／083-772-2680。定休 元日。",
    order: "たかせのお取り寄せ（提案デモ）。瓦そばセットなど、家庭で味わう構成例。"
  };
  const views = $$(".view");
  ...
  function renderCart() {
    ...
    if (ids.length === 0) {
      cartItemsEl.innerHTML = `<div class="cart-empty"><p>カートは空です。<br>瓦そばセットはいかがですか？</p><a class="btn btn-primary" href="#/order">お取り寄せを見る</a></div>`;
    } else {
