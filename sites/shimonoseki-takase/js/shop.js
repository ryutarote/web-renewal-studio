...
const PRODUCTS = [
  {
    id: "kawarasoba-set",
    name: "瓦そばセット（2人前）",
    desc: "茶そばとつゆ、具材のセット。フライパンやホットプレートで。",
    price: 2200,
    grad: "radial-gradient(circle at 42% 32%, #c8b86a, #1f3a24 72%)",
    note: "構成例（目安）"
  },
  {
    id: "chasoba",
    name: "茶そば（生・3人前）",
    desc: "鮮やかな緑の茶そば。瓦そばや温そばに。",
    price: 1200,
    grad: "radial-gradient(circle at 45% 35%, #3a6a3a, #14301a 72%)"
  },
  {
    id: "kawara-dashi",
    name: "瓦そばのつゆ",
    desc: "温かいつけつゆ。瓦そばや温麺に。",
    price: 700,
    grad: "linear-gradient(135deg, #1f3a24, #c8b86a)"
  }
];
...
const CART_KEY = "shimonoseki_takase_cart_v1";
