...
(function () {
  ...
  const DESC = {
    home:  "道頓堀の黒毛和牛専門店「はり重」（リニューアル提案）。大正8年創業。厳選した黒毛和牛のすき焼き・しゃぶしゃぶから、洋食「グリル」、名物の「はり重カレー」まで。ミナミの一棟で。",
    menu:  "はり重のお品書き。黒毛和牛すき焼き、はり重カレー、ビーフカツサンドなど。価格は税込・目安です。大阪・道頓堀。",
    story: "はり重の歩み。大正8年創業。黒毛和牛専門店として、日本料理・洋食・精肉販売まで手がける道頓堀の老舗。",
    shop:  "はり重 道頓堀本店の店舗情報・アクセス。大阪市中央区道頓堀1-9-17／06-6211-7777。なんば駅すぐ。定休 火曜。",
    order: "はり重のお取り寄せ（提案デモ）。黒毛和牛すき焼きセットやカレーなど、家庭で味わう構成例。"
  };
  const views = $$(".view");
  ...
  function renderCart() {
    ...
    if (ids.length === 0) {
      cartItemsEl.innerHTML = `<div class="cart-empty"><p>カートは空です。<br>黒毛和牛セットやはり重カレーはいかがですか？</p><a class="btn btn-primary" href="#/order">お取り寄せを見る</a></div>`;
    } else {
